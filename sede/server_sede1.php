...
class servizio {
    ...
    public function inserisci_fornitore($articolo) {
        ...
        mysqli_select_db($db_connect, 'magazzino1') or die('Could not select database'); //seleziona database
...
rename($wsdl, "./cache/server_sede1.wsdl");
$server = new SoapServer("http://localhost/sede/cache/server_sede1.wsdl");
