...
#CREAZIONE DB
$query = 'CREATE DATABASE if not exists magazzino2;';
$result = mysqli_query($db_connect, $query) or die('Impossibile creare db locale');

mysqli_select_db($db_connect, 'magazzino2') or die('Could not select database');
...
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '1', '1', 'marzo');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '1', '4', 'aprile');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '2', '2', 'giugno');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '3', '17', 'febbraio');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '3', '5', 'luglio');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '5', '12', 'ottobre');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '2', '9', 'gennaio');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '4', '7', 'giugno');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '4', '4', 'agosto');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '6', '13', 'dicembre');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '7', '16', 'novembre');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '2', '1', 'settembre');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '4', '3', 'novembre');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
$query = "INSERT INTO vendita (`id_vendita`, `prodotto`, `quantita`, `data`) VALUES (NULL, '1', '4', 'marzo');";
$result = mysqli_query($db_connect, $query) or die('inserimento2 ' . mysqli_error($db_connect));
